    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-auto p-4 flex flex-col gap-4">
          ...
          <div>
            ...
            <div className="flex flex-col gap-0.5 max-h-40 overflow-auto">
              {frame.childLayers.map((layer, i) => (
                <div
                  key={i}
                  className="flex items-center justify-between text-xs px-1 py-0.5 rounded hover:bg-gray-50"
                >
        ...
        {group && group.frames.length > 1 && (
          <div>
            <h3 className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">
              Grouped with ({group.frames.length - 1} other frame
              {group.frames.length > 2 ? 's' : ''})
            </h3>
