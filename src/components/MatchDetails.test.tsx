...
describe('MatchDetails', () => {
  it('returns null when all arrays empty', () => {
    const { container } = render(
      <MatchDetails componentUsage={[]} nameMatches={[]} libraryMatches={[]} onOpenInFigma={vi.fn()} />,
    );
  ...
  it('renders component usage section', () => {
    render(
      <MatchDetails
        componentUsage={[
          { id: 'c1', name: 'Button', description: 'Primary button', fileKey: 'fk1', fileName: 'Lib', fileUrl: '' },
        ]}
        nameMatches={[]}
        libraryMatches={[]}
        onOpenInFigma={vi.fn()}
  ...
  it('pluralizes component count', () => {
    render(
      <MatchDetails
        componentUsage={[
          { id: 'c1', name: 'Button', description: '', fileKey: 'fk1', fileName: 'Lib', fileUrl: '' },
          { id: 'c2', name: 'Input', description: '', fileKey: 'fk1', fileName: 'Lib', fileUrl: '' },
        ]}
        nameMatches={[]}
        libraryMatches={[]}
        onOpenInFigma={vi.fn()}
  ...
  it('renders fuzzy name matches', () => {
    render(
      <MatchDetails
        componentUsage={[]}
        nameMatches={[
          { id: 'n1', name: 'Dialog', description: 'A modal dialog component', fileKey: 'fk1', fileName: 'Lib', fileUrl: '' },
        ]}
        libraryMatches={[]}
        onOpenInFigma={vi.fn()}
      />,
  ...
  it('truncates long descriptions', () => {
    ...
    render(
      <MatchDetails
        componentUsage={[]}
        nameMatches={[
          { id: 'n1', name: 'Thing', description: longDesc, fileKey: 'fk1', fileName: 'Lib', fileUrl: '' },
        ]}
        libraryMatches={[]}
        onOpenInFigma={vi.fn()}
      />,
  ...
  it('calls onOpenInFigma with correct URL for library match', () => {
    ...
    render(
      <MatchDetails
        ...
        nameMatches={[]}
        libraryMatches={[
          { componentId: '1:23', componentName: 'Card', similarity: 75, fileKey: 'fk1', fileUrl: '' },
        ]}
  ...
  it('calls onOpenInFigma for component usage button', () => {
    ...
    render(
      <MatchDetails
        componentUsage={[
          { id: '2:34', name: 'Button', description: '', fileKey: 'fk2', fileName: 'Lib', fileUrl: '' },
        ]}
        nameMatches={[]}
        libraryMatches={[]}
        onOpenInFigma={onOpen}
