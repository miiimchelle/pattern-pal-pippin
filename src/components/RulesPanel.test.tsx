...
const defaultRules: RuleConfig[] = [
  { id: 'primary-button-limit', name: 'Primary Button Limit', description: 'Max one primary button per screen', enabled: true },
  { id: 'text-style-consistency', name: 'Text Style Consistency', description: 'Text nodes should use text styles', enabled: true },
  { id: 'spacing-consistency', name: 'Spacing Consistency', description: 'Auto-layout spacing values should be consistent', enabled: false },
  { id: 'color-token-usage', name: 'Color Token Usage', description: 'Solid fills should reference a style', enabled: true },
  { id: 'contrast-ratio', name: 'Contrast Ratio (WCAG AA)', description: 'Text must meet WCAG AA contrast', enabled: true },
];
