...
describe('TeamFileResults', () => {
  ...
  it('applies green color class for high consistency', () => {
    const { container } = render(
      <TeamFileResults fileResults={[makeFileResult({ consistency: 95 })]} onOpenInFigma={vi.fn()} />,
    );
  ...
  it('applies red color class for low consistency', () => {
    const { container } = render(
      <TeamFileResults fileResults={[makeFileResult({ consistency: 30 })]} onOpenInFigma={vi.fn()} />,
    );
