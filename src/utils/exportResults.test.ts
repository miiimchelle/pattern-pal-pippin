  ...
  teamFileResults: [
    {
      ...
      consistency: 85,
      matches: [
        { teamFrameId: 't1', teamFrameName: 'Login', localFrameId: '1', localFrameName: 'Login Screen', similarity: 85 },
      ],
    },
  ],
  libraryMatches: [
    { componentId: 'c1', componentName: 'Button', similarity: 92, fileKey: 'lib1', fileUrl: 'https://figma.com/file/lib1' },
  ],
...
const patternGroups: PatternGroup[] = [
  {
    ...
    frames: [
      {
        id: '1', name: 'Login', width: 375, height: 812, childCount: 5, maxDepth: 3,
        componentIds: [], componentNames: [], aspectRatio: 0.46, layoutMode: 'VERTICAL',
        cornerRadius: 0, hasAutoLayout: true, fillCount: 1, childTypeDistribution: {},
        fileKey: 'f1', fileName: 'File A',
      },
      {
        id: '2', name: 'Register', width: 375, height: 812, childCount: 5, maxDepth: 3,
        componentIds: [], componentNames: [], aspectRatio: 0.46, layoutMode: 'VERTICAL',
        cornerRadius: 0, hasAutoLayout: true, fillCount: 1, childTypeDistribution: {},
        fileKey: 'f2', fileName: 'File B',
      },
    ],
    consistency: 80,
    componentUsage: [],
